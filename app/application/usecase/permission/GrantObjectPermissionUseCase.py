...
class GrantObjectPermissionUseCase:
    def __init__(
        self,
    ...
    async def execute(self, command: GrantObjectPermissionCommand) -> None:
        ...
        async with self._tx():
            ...
            # Check if permission already exists for this subject; if so, delete it first
