...
class SqlAlchemyObjectRepository:
    ...
    async def find_by_id(self, object_id: Id) -> DataObject | None:
        ...
        entity = await session.get(DataObjectEntity, object_id.to_bytes())
    ...
    async def find_by_id_for_update(self, object_id: Id) -> DataObject | None:
        ...
        stmt = (
            ...
            .where(DataObjectEntity.object_id == object_id.to_bytes())
            .with_for_update()
        )
    ...
    async def find_by_owner(
        ...
        stmt = select(DataObjectEntity).where(
            DataObjectEntity.owner_identity_id == owner_identity_id.to_bytes()
        )
